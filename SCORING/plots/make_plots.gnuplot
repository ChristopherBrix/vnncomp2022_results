...
set style line 1 lc rgb "#ff4040" lw 4.5 dt 2
...
timeout_y_list = '300'
timeout_x_list = '7'
timeout_str_list = "'Five Minutes'"

key_list = "'1400 1000'"
key_font_str_list = ",20"
key_box_str_list = 'box'
all_instances_y_list = '3'

ratio_list = '0.5'
sizex_list = '7.0'
sizey_list = '3'

time_label_offset_list = '1.7 '
lmargin_str_list = '0.08'
...
#set arrow 52 from xmax, ymin_str to xmax, ymax_str nohead ls 8 
